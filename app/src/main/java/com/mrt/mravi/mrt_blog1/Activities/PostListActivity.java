...
//ads
        ...
        AccountHeader headerResult = new AccountHeaderBuilder()
                ...
                .addProfiles(
                        new ProfileDrawerItem().withName("AGI").withEmail("cvsr.ac.in").withIcon(getResources().getDrawable(R.drawable.cvsr1))
                )
       ...
       // PrimaryDrawerItem item10= new PrimaryDrawerItem().withIdentifier(10).withName("Articles").withIcon(getResources().getDrawable(R.drawable.others));
        ...
        Drawer result = new DrawerBuilder()
                ...
                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        switch (position) {
                            case 1:
                                //Toast.makeText(PostListActivity.this, "home", Toast.LENGTH_SHORT).show();
                               // Intent i = new Intent(PostListActivity.this, PostListActivityEducation.class);
                                Intent i = new Intent(PostListActivity.this, PostListActivityEducation.class);
                            ...
                            case 2:
                                // Toast.makeText(PostListActivity.this, "Setting", Toast.LENGTH_SHORT).show();
                                //Intent is = new Intent(PostListActivity.this, PostListActivityResearch.class);
                                Intent is = new Intent(PostListActivity.this, Articles.class);
                            ...
                            case 3:
                                //Toast.makeText(PostListActivity.this, "Setting", Toast.LENGTH_SHORT).show();
                                Intent isa = new Intent(PostListActivity.this, PostListActivityAnnouncement.class);
                                startActivity(isa);
                                finish();
                                break;
                            case 4:
                                Toast.makeText(PostListActivity.this, "You ARE in Others Page", Toast.LENGTH_SHORT).show();
                                Intent b = new Intent(PostListActivity.this, MainActivityMD7.class);
                                startActivity(b);
                                finish();
                                break;
                            case 5:
                                Toast.makeText(PostListActivity.this, "Articles1", Toast.LENGTH_SHORT).show();
                            ...
                            case 6:
                                ...
                                Toast.makeText(PostListActivity.this, "Publish", Toast.LENGTH_SHORT).show();
                                Intent bs = new Intent(PostListActivity.this, PublishActivity.class);
                                startActivity(bs);
                                finish();
...
*/
                            ...
                            case 7:
                               // Intent az=new Intent(PostListActivity.this,Team.class);
                                ...
                                Toast.makeText(PostListActivity.this, "Under Process", Toast.LENGTH_SHORT).show();
...
/*
        if (mUser != null && mAuth != null) {
            ...
            if (!email.equals("cvsr@gmail.com")) {
                ...
                View b=findViewById(R.id.fabSpeedDial);
                b.setVisibility(4);
            }
        }
        */
...
//                        assert email != null;
                        if (email.equals("cvsr@gmail.com")||email.equals("cse3a@gmail.com")||email.equals("cse3b@gmail.com")||email.equals("cse3c@gmail.com")||email.equals("cse3d@gmail.com")) {
                            ...
                            Toast.makeText(PostListActivity.this, "you are not admin", Toast.LENGTH_SHORT).show();
