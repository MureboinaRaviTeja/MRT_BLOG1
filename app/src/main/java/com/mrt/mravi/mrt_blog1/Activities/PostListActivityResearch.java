...
public class  PostListActivityResearch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_post_listresearch);
        ...
        Drawer result = new DrawerBuilder()
                ...
                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        switch(position){
                            case 1:
                                Toast.makeText(PostListActivityResearch.this, "home", Toast.LENGTH_SHORT).show();
                                Intent i=new Intent(PostListActivityResearch.this, PostListActivityEducation.class);
                                startActivity(i);
finish();
                                break;

                            case 2:
                                Toast.makeText(PostListActivityResearch.this, "YOU r in Research Page", Toast.LENGTH_SHORT).show();
                                //Intent is=new Intent(PostListActivityResearch.this, PostListActivity.class);
                                //startActivity(is);
                                break;
                            case 3:
                             //   Toast.makeText(PostListActivityEducation.this, "Setting", Toast.LENGTH_SHORT).show();
                               Intent isa=new Intent(PostListActivityResearch.this, PostListActivityAnnouncement.class);
                                startActivity(isa);
                                finish();
                                break;
                            case 4:
                                Intent bs=new Intent(PostListActivityResearch.this,PostListActivity.class);
                                startActivity(bs);
                                finish();
                            ...
                            case 5:
                                Toast.makeText(PostListActivityResearch.this, "Sign out", Toast.LENGTH_SHORT).show();
                            ...
                            case 6:
                                ...
                                Toast.makeText(PostListActivityResearch.this, "Publish", Toast.LENGTH_SHORT).show();
                                Intent bas=new Intent(PostListActivityResearch.this,PublishActivity.class);
                                startActivity(bas);
                                finish();
...
*/
                            ...
                            case 8:
                                ...
                                if (mUser != null && mAuth != null) {
                                    ...
                                    startActivity(new Intent(PostListActivityResearch.this, MainActivityMD7.class));
                                    finish();//so that  when user cliks back they will not able to see
                            ...
                            case 7:
                                Intent az=new Intent(PostListActivityResearch.this,Team.class);
                                startActivity(az);
...
*/
                ...
                if(post.equals("ADD POST"))
                {
                    if(mUser!=null&&mAuth!=null){
                        ...
                        if(email.equals("cvsr@gmail.com")||email.equals("cse3a@gmail.com")||email.equals("cse3b@gmail.com")||email.equals("cse3c@gmail.com")||email.equals("cse3d@gmail.com")) {
                            startActivity(new Intent(PostListActivityResearch.this, AddPostActivityResearch.class));
                            finish();

                        }
                        else{
                            Toast.makeText(PostListActivityResearch.this, "YOU ARE NOT ADMIN", Toast.LENGTH_SHORT).show();
                        }
        ...
        mDatabaseReference=mDatabase.getReference().child("MBlogResearch");
    ...
    protected void onStart() {
        ...
        mDatabaseReference.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                blogRecyclerAdapter=new BlogRecyclerAdapter(PostListActivityResearch.this,blogList);
