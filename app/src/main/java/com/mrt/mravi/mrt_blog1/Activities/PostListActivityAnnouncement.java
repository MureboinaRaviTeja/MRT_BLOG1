...
//import com.example.mravi.mrt_blog1.EducationActivity.AddPostActivityEducation;
//import com.example.mravi.mrt_blog1.EducationActivity.PostListActivityEducation;
...
import static com.mrt.mravi.mrt_blog1.R.string.email;

public class PostListActivityAnnouncement extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_post_listannouncement);
    ...
    //    SecondaryDrawerItem item6 = (SecondaryDrawerItem) new SecondaryDrawerItem().withIdentifier(5).withName("Signout").withIcon(getResources().getDrawable(R.drawable.signout));
        ...
        Drawer result = new DrawerBuilder()
                ...
                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        switch(position){
                            case 1:
                                Toast.makeText(PostListActivityAnnouncement.this, "home", Toast.LENGTH_SHORT).show();
                                Intent i=new Intent(PostListActivityAnnouncement.this,PostListActivityEducation.class);
                                startActivity(i);
                                finish();
                            ...
                            case 2:
                                Intent ia=new Intent(PostListActivityAnnouncement.this,Articles.class);
                                startActivity(ia);
                                finish(); break;
                            case 3:
                                Toast.makeText(PostListActivityAnnouncement.this, "announcemnt Page", Toast.LENGTH_SHORT).show();
                                break;
                            case 4:
                                Intent iaa=new Intent(PostListActivityAnnouncement.this,PostListActivity.class);
                                startActivity(iaa);
                                finish(); break;
                            case 5:
                                Toast.makeText(PostListActivityAnnouncement.this, "Sign out", Toast.LENGTH_SHORT).show();
                            ...
                            case 6:
                                ...
                                Toast.makeText(PostListActivityAnnouncement.this, "Publish", Toast.LENGTH_SHORT).show();
                                Intent bs=new Intent(PostListActivityAnnouncement.this,PublishActivity.class);
                                startActivity(bs);
                                finish();
...
*/
                            ...
                            case 8:
                                ...
                                Intent az=new Intent(PostListActivityAnnouncement.this,Team.class);
                                startActivity(az);
                                finish();
...
*/
                            ...
                            case 7:
                                ...
                                Toast.makeText(PostListActivityAnnouncement.this, "Under Process", Toast.LENGTH_SHORT).show();
                                Intent bz=new Intent(PostListActivityAnnouncement.this,MRTCHAT.class);
                                startActivity(bz);
                                finish();
                            ...
                            case 9:
                                ...
                                if (mUser != null && mAuth != null) {
                                    ...
                                    startActivity(new Intent(PostListActivityAnnouncement
                                            .this, MainActivityMD7.class));
                                    finish();//so that  when user cliks back they will not able to see
...
*/
            ...
            public boolean onMenuItemSelected(MenuItem menuItem) {
                ...
                if(post.equals("ADD POST"))
                {
                    if(mUser!=null&&mAuth!=null){
                        ...
                        if(email.equals("cvsr@gmail.com")||email.equals("cse3a@gmail.com")||email.equals("cse3b@gmail.com")||email.equals("cse3c@gmail.com")||email.equals("cse3d@gmail.com")) {
                            startActivity(new Intent(PostListActivityAnnouncement.this, AddPostActivityAnnouncement.class));
                            finish();

                        }
                        else{
                            Toast.makeText(PostListActivityAnnouncement.this, "", Toast.LENGTH_SHORT).show();
                        }
                ...
                if(post.equals("Signout")){
                    ...
                    if(mUser!=null&&mAuth!=null){
                        ...
                        startActivity(new Intent(PostListActivityAnnouncement.this,MainActivityMD7.class));
                        finish();//so that  when user cliks back they will not able to see
        ...
        mDatabaseReference=mDatabase.getReference().child("MBlogAnnouncement");
        ...
        switch (item.getItemId()){
            ...
            case R.id.action_add:
                if(mUser!=null&&mAuth!=null){
                    ...
                    String email=mUser.getEmail();
                    if(email.equals("cvsr@gmail.com")) {
                        startActivity(new Intent(PostListActivityAnnouncement.this, AddPostActivity.class));
                        finish();
                    }
                    else {
    ...
    protected void onStart() {
        ...
        mDatabaseReference.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                blogRecyclerAdapter=new BlogRecyclerAdapter(PostListActivityAnnouncement.this,blogList);
